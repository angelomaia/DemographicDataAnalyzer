...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round(higher_education/((df.education == 'Bachelors') | 
                                                 (df.education == 'Masters') | 
                                                 (df.education == 'Doctorate')).sum()*100, 1)
    lower_education_rich = round(lower_education/((df.education != 'Bachelors') & 
                                              (df.education != 'Masters') & 
                                              (df.education != 'Doctorate')).sum()*100, 1)
    ...
    rich_percentage = df[df.salary == '>50K']['hours-per-week'].value_counts()[1]/df['hours-per-week'].value_counts()[1]*100
